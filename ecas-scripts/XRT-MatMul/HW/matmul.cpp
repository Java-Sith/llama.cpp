...
void matmul(RawDataT *a, RawDataT *b, RawDataT *c, int a_rows, int b_cols,
            int c_cols) {
#pragma HLS INTERFACE m_axi offset = slave port = a bundle = gmem0 depth = 1024
#pragma HLS INTERFACE m_axi offset = slave port = b bundle = gmem1 depth = 1024
#pragma HLS INTERFACE m_axi offset = slave port = c bundle = gmem2 depth = 1024
